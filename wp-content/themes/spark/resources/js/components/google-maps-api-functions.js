 ...
 * Create API key and add it to existing function in app/theme/actions.php
...
// import {new_map} from '../components/google-maps-api-functions'
...
// @set($location = get_field('location'))
// @if(!empty($location))
// <div class="acf-map">
//   <div class="marker"
